...
public class NewMainMenu_Hypothetical_ContextMenu : MonoBehaviour
{
    ...
    private void CheckUpdateScreenText()
    {
        if (previousSelected != CurrentSelected)
        {
            ...
            string text = "";
            string[] array = new string[2] { "遊玩 ", "返回" };
    ...
    private void SetupHypothetical()
    {
        ...
        HypotheticalDescription.text = "<color=grey>猜想是這樣的...\n\n</color>" + CurrentHypothesis.HypothesisDescription;
        ...
        string text = "";
        text = ((CurrentHypothesis.HypothesisGoals.Length == 0) ? (text + "<color=red>【本猜想沒有小任務】</color>") : (text + "<color=green>【可選有獎小任務】</color>"));
        ...
        foreach (HypothesisGoal hypothesisGoal in hypothesisGoals)
        {
            ...
            {
                text = ((@int == 0) ? (text + "<color=white>(未完成)") : (text + "<color=yellow>(已完成)"));
            }
