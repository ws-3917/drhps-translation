...
public class NewMainMenu_DiscordSubMenu : MonoBehaviour
{
    ...
    private IEnumerator SelectSubMenuTimer()
    {
        ...
        {
            Application.OpenURL("https://discord.gg/wcQqR88X2A");
        }
        ConsoleMenu.SetActive(value: true);
        base.gameObject.SetActive(value: false);
    }
    ...
    private void CheckUpdateScreenText()
    {
        if (previousSelected != CurrentSelected)
        {
            ...
            string text = "<b>在浏览器中打开\n邀请连结？</b>\n";
            string[] array = new string[2] { "是 ", "否" };
