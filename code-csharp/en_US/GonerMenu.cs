        ...
        if (CurrentActiveHypothesis != null)
        {
            ...
            foreach (HypothesisGoal hypothesisGoal in hypothesisGoals)
            {
                ...
                if (hypothesisGoal.RequiredTasks > 1)
                {
                    ...
                    {
                        TextMeshProUGUI currentQuestsText = CurrentQuestsText;
                        currentQuestsText.text = currentQuestsText.text + "<color=yellow>" + hypothesisGoal.GoalHint + " (" + @int + "/" + hypothesisGoal.RequiredTasks + ")</color>\n";
                    }
                }
                else if (@int != 0)
                {
                    TextMeshProUGUI currentQuestsText2 = CurrentQuestsText;
                    currentQuestsText2.text = currentQuestsText2.text + "<color=yellow>" + hypothesisGoal.GoalHint + " (X)</color>\n";
                }
                else
                {
                    TextMeshProUGUI currentQuestsText3 = CurrentQuestsText;
                    currentQuestsText3.text = currentQuestsText3.text + "<color=white>" + hypothesisGoal.GoalHint + " (-)</color>\n";
                }
            }
        }
        else
